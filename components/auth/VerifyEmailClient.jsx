...
export default function VerifyEmailClient() {
  ...
  // Kolory z tokenów, nie z literałów — zaszyte `#fff` dawało w trybie ciemnym
  // biały prostokąt pośrodku ciemnej strony.
        ...
        <div style={formContainerStyle}>
          {status === 'verifying' && (
            <>
              ...
              <h2 style={{ marginTop: 0, marginBottom: '15px', color: 'var(--text)' }}>{t('verify_email_verifying')}</h2>
              <p style={{ margin: 0, color: 'var(--muted)' }}>{t('verify_email_please_wait')}</p>
            </>
          )}
