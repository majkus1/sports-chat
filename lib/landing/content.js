		...
		return {
			...
			how: {
				...
				steps: [
					...
					{ title: 'Join the conversation', body: 'Follow the game with other fans in the match room, ask the assistant whatever the analysis left out, and place your pick. We settle it after the whistle.' },
				],
			},
			accuracy: {
	...
	return {
		...
		how: {
			...
			steps: [
				...
				{ title: 'Wejdź w rozmowę', body: 'Skomentuj mecz z innymi kibicami w pokoju spotkania, dopytaj asystenta o to, czego w analizie zabrakło, i wystaw typ. Rozliczymy go po gwizdku.' },
			],
		},
		accuracy: {
