...
export const ANALYSIS_MESSAGES = {
	pl: {
		...
		/*
		 * Komunikat MUSI powiedzieć, że chodzi o analizę TEGO UŻYTKOWNIKA i być może INNEGO
		 * MECZU — bo blokada jest na konto, nie na mecz.
		 *
		 * Poprzednie brzmienie („Analiza jest już generowana") czytało się na stronie meczu
		 * jak zdanie o TYM meczu: ktoś czekał na analizę Santa Clary, choć w drugiej karcie
		 * generowała mu się analiza meczu w Japonii. Nie było też skąd wiedzieć, czy limit
		 * dotyczy konta, czy całego serwisu.
		 */
		inProgress:
			'Trwa generowanie Twojej analizy — być może innego meczu. Naraz powstaje tylko jedna, więc poczekaj, aż tamta się skończy.',
		viewLimit:
	...
	en: {
		...
		inProgress:
			'One of your analyses is still being generated — possibly for a different match. Only one runs at a time, so please wait for it to finish.',
		viewLimit:
