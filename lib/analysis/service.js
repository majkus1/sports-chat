...
import { modelForBundle, bindAnalysisToModel } from '@/lib/analysis/model';
...
function presentSections(bundle) {
	if (!bundle) return [];
	// `model` to nasz własny rachunek doklejony do pakietu, nie sekcja danych od dostawcy.
	const pomijane = new Set(['fetchedAt', 'sections', 'missing', 'model']);
