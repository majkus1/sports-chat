...
/**
 * Rozgrywki dopuszczone do kolejki, w dwóch poziomach ważności.
 *
 * Poziom 1 wchodzi do zestawu przed poziomem 2. Identyfikatory są stałe po stronie
 * API-Football. Czego nie ma na liście, nie trafia do kolejki w ogóle — lepszy zestaw
 * ośmiu znanych meczów niż dwunastu z dopełnieniem przypadkowymi rozgrywkami.
 */
const LEAGUE_TIERS = new Map([
