 ...
 *
 * Kategorie są dwie i obie są prawdziwe: skrypt logowania Google i Google Analytics.
 * Każda odpowiada rzeczywistemu skryptowi, który bez zgody nie wchodzi na stronę —
 * baner z wyborem, który niczego nie zmienia, byłby gorszy niż jego brak.
 *
 * Reklam nie ma i ta lista nie jest miejscem „na przyszłość": kategorię dopisujemy
 * dopiero razem ze skryptem, który ma za nią stać.
 */
 ...
 *
 * Wersja 2: doszła analityka. Zgoda z wersji 1 dotyczyła innego zakresu (samo logowanie
 * Google), więc nie może obejmować skryptu, o którym użytkownik nie wiedział.
 */
...
export const OPTIONAL_CATEGORIES = ['google', 'analytics'];

const DEFAULT_CONSENT = { version: CONSENT_VERSION, google: false, analytics: false, decidedAt: null };
