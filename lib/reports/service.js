...
/**
 * PRÓG MUSI ZALEŻEĆ OD RYNKU, BO CZĘSTOŚCI BAZOWE SIĘ RÓŻNIĄ.
 *
 ...
 *
 * Częstości bazowe wyliczone z 3590 meczów uczących w backteście:
 *
 *     zwycięstwo gospodarzy     43,8%      podwójna szansa 1X    69,3%
 *     zwycięstwo gości          30,7%      podwójna szansa X2    56,2%
 *     gospodarz strzeli gola    78,6%      gość strzeli gola     70,0%
 *
 * Próg każdego rynku stoi wyraźnie POWYŻEJ jego częstości, żeby typ niósł informację,
 * a nie powtarzał tego, co i tak wiadomo bez patrzenia na mecz.
 */
const MIN_PROBABILITY_DOUBLE_CHANCE = 74;
const MIN_PROBABILITY_TEAM_GOALS = 85;

/** Próg wejścia dla danego rynku. */
function minProbabilityFor(market) {
	if (market === 'Podwójna szansa') return MIN_PROBABILITY_DOUBLE_CHANCE;
	if (market === 'Gole drużyny') return MIN_PROBABILITY_TEAM_GOALS;
