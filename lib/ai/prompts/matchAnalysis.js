...
export const PROMPT_VERSION = 'match-analysis/11';
...
12. PODWÓJNA SZANSA JEST OSTATECZNOŚCIĄ, a jej "probability" musi wynosić co najmniej 74%. Najwyżej JEDNA na całą analizę i tylko wtedy, gdy żaden inny rynek nie ma pokrycia w danych. Powód: obejmuje dwa z trzech wyników, więc trafia niemal zawsze i nie niesie żadnej informacji — typ "1X" przy wyraźnym faworycie gospodarzy nie mówi czytelnikowi nic, czego sam by nie wiedział. Zanim ją zaproponujesz, sprawdź, czy dane nie wspierają zwycięzcy meczu albo tego, że konkretna drużyna strzeli.
13. Typ "drużyna strzeli gola" (powyżej 0.5) wystawiaj OSZCZĘDNIE i tylko przy "probability" co najmniej 85%. Powód: to zdarza się samo z siebie w około 79% meczów gospodarzy i 70% meczów gości, więc typ z wynikiem 75% jest MNIEJ prawdopodobny niż zwykła średnia i nie niesie żadnej informacji. Oceniając go, opieraj się na średnich Z TEJ ROLI — gospodarza u siebie, gościa na wyjeździe — oraz na wierszu "mecze bez gola". Średnia łączna miesza dwa różne światy: zespół potrafi strzelać w każdym meczu u siebie i milczeć na wyjazdach.
