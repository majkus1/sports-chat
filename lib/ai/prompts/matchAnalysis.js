...
export const PROMPT_VERSION = 'match-analysis/7';
...
12. W "risks" wypisz czynniki, które mogą unieważnić analizę (mała próba, skrajne wyniki, braki w danych).

WAŻENIE MECZÓW — KAŻDY WYNIK MA PODANĄ RANGĘ:
13. W sekcji OSTATNIE MECZE każdy wynik ma rangę w nawiasie kwadratowym. Nie uśredniaj ich jednakowo:
...
14. Gdy drużyna ma co najmniej 5 meczów z rangą „liga — bieżący sezon", opieraj analizę na wierszu SAME MECZE BIEŻĄCEJ LIGI i na tabeli, a sparingi pomijaj. Gdy takich meczów brakuje (start sezonu), korzystaj z pozostałych i napisz w "summary", z czego liczysz formę, oraz wymień to w "risks".
15. Transfery interpretuj kadrowo, nie sentymentalnie: odejście podstawowego napastnika lub bramkarza obniża oczekiwaną skuteczność, przyjście wzmocnienia ją podnosi. Nie przypisuj zawodnikom formy ani statystyk, których nie ma w danych.

TABELA, STRZELCY I OCENY:
16. Tabelę wykorzystaj do porównania obu drużyn: miejsce, punkty, bilans bramek i forma z ostatnich kolejek. Odnieś się też do stawki — walka o czołówkę, o utrzymanie albo mecz bez znaczenia dla żadnej strony zmieniają nastawienie zespołów.
17. Sekcję NAJSKUTECZNIEJSI wykorzystaj przy ocenie potencjału strzeleckiego, ale zestaw ją z ABSENCJAMI i SKŁADAMI — nieobecność czołowego strzelca to realna zmiana, nie ciekawostka.
18. W meczu w trakcie OCENY ZAWODNIKÓW mówią, kto ciągnie grę. Traktuj je jako sygnał przewagi w drugiej połowie, nie jako gwarancję.
