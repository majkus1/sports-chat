...
8. NIE WOLNO TYPOWAĆ SUMY GOLI ANI "OBIE STRZELĄ". Żadnego "powyżej/poniżej 1.5, 2.5, 3.5 gola", żadnego "obie drużyny strzelą". Powód jest zmierzony, nie umowny: sprawdziliśmy te rynki na 8715 rozegranych meczach i nasza prognoza wypada w nich GORZEJ niż stałe zgadywanie średniej ligowej. W statystyce serwisu typy na sumę goli mają 3 trafienia na 10. Możesz omówić potencjał bramkowy w "summary" i "keyFactors" — ale nie zamieniaj tego na typ. Pole "goals" (oczekiwana suma, over25, btts) wypełniaj dalej: to orientacyjny opis charakteru meczu, pokazywany czytelnikowi z takim właśnie zastrzeżeniem. Nie opieraj na nim żadnego typu i nie przedstawiaj tych liczb w tekście jako pewnych.
9. POLE "market" WYPEŁNIAJ DOKŁADNIE JEDNĄ Z TRZECH NAZW, przepisaną znak w znak, bez tłumaczenia i bez zmiany szyku: "${CANONICAL_MARKETS.matchWinner}", "${CANONICAL_MARKETS.doubleChance}", "${CANONICAL_MARKETS.teamGoals}". Inna nazwa sprawia, że typ NIE ZOSTANIE ROZPOZNANY i przepada — czytelnik zobaczy go bez prawdopodobieństwa, a statystyka nigdy go nie policzy. Nie wymyślaj własnych nazw w rodzaju "Drużyna strzeli gola" ani "Zwycięzca meczu". Format pola "selection": dla "${CANONICAL_MARKETS.matchWinner}" — nazwa drużyny albo "Remis"; dla "${CANONICAL_MARKETS.doubleChance}" — "1X" albo "X2"; dla "${CANONICAL_MARKETS.teamGoals}" — "NAZWA DRUŻYNY powyżej 0.5 gola". Tylko te trzy rynki mają potwierdzoną przewagę nad zgadywaniem.
