 ...
 * Każdy rynek ma własny próg wejścia, wyższy od swojej częstości bazowej. Model dostaje gotową krótką listę z pełnymi faktami — jego
...
export const REPORT_PROMPT_VERSION = 'report/3';
...
3. Dla zaakceptowanego meczu wybierz DOKŁADNIE JEDEN rynek — spośród PROPONOWANYCH RYNKÓW tego meczu ten, który dane wspierają najmocniej.
...
5. "probability" to TWOJA ocena prawdopodobieństwa (55–92). Wyjściowy procent selekcji bywa zawyżony przez zgrubne dane — koryguj go w dół, gdy forma nie daje mu pełnego pokrycia. "confidence" (0–100) wyraża, jak mocno dane wspierają typ.
