...
/** Pełne przeładowanie — spójny stan po rotacji tokenów (socket, React, cache). */
...
/**
 * fetch z credentials; przy 401 → refreshAccessToken() → przeładowanie strony (świeży stan sesji).
 */
