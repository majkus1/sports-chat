 ...
 */
/** Ułamek meczu, który jeszcze zostanie rozegrany; po 90. minucie ~3 minuty doliczone. */
export function remainingFraction(minute) {
	...
	return pozostalo > 0 ? pozostalo : 3 / REGULATION_MINUTES;
}

export function inPlayMarkets({ lambdaHome, lambdaAway, homeGoals = 0, awayGoals = 0, minute = 0 }) {
	const ulamek = remainingFraction(minute);
