 ...
 *
 * WERSJA ZWERYFIKOWANA BACKTESTEM. Na 3541 meczach testowych z dziesięciu czołowych lig
 * (podział po dacie, model przeliczany co 14 dni, wyłącznie na spotkaniach rozegranych
 * wcześniej):
 *
 *     log loss 1X2   1,0218  wobec 1,0756 dla częstości    t = 7,58
 *     trafienia 1X2   49,5%  wobec  43,4%
 *
...
export const USABLE_MARKETS = {
	matchWinner: true, //           log loss 1,0218 wobec 1,0756
	doubleChance: true, //          +0,0179 (1X) i +0,0222 (X2)
	teamGoalsOver05: true, //       +0,0036 (gospodarz) i +0,0046 (gość)
	totalGoals: false, //           −0,0020 / −0,0030 / −0,0007 — gorzej niż stała
	btts: false, //                 −0,0047 — gorzej niż stała
};
