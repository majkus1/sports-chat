...
/** Strzały (i xG, gdy dostawca je ma) obu stron z odpowiedzi `fixtures/statistics`. */
export function parseShots(rawList, { homeId, awayId }) {
	const out = { hs: null, as: null, hst: null, ast: null, hxg: null, axg: null };
	for (const entry of rawList || []) {
		...
		const xg = liczba(stats.expected_goals);
